...
public class QueueCtrl {
    ...
    public ResponseEntity<QueueEnterResponse> enter(
        ...
        return ResponseEntity.ok(
                queueService.enter(eventProductId, userPrincipal.getUserId())
        );
    }
    ...
    public ResponseEntity<QueueRankResponse> getRank(
        ...
        return ResponseEntity.ok(
                queueService.getRank(eventProductId, userPrincipal.getUserId())
        );
    }
    ...
    public ResponseEntity<QueueStatusResponse> getStatus(
        ...
        return ResponseEntity.ok(
                queueService.getStatus(eventProductId, userPrincipal.getUserId())
        );
    }
    ...
    public ResponseEntity<QueueAvailableResponse> getAvailable(
        ...
        return ResponseEntity.ok(
                queueService.getAvailable(eventProductId, userPrincipal.getUserId())
        );
    }
    ...
    public ResponseEntity<QueueEstimatedTimeResponse> getEstimatedTime(
        ...
        return ResponseEntity.ok(
                queueService.getEstimatedTime(eventProductId, userPrincipal.getUserId())
        );
    }
    ...
    @Operation(summary = "테스트용 대기열 진입", description = "부하 테스트용 API입니다.")
