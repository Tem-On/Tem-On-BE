package com.example.temon.queuestockservice.notification.ctrl;

import com.example.temon.queuestockservice.global.jwt.ApiUserPrincipal;
import com.example.temon.queuestockservice.notification.domain.dto.NotificationRequest;
import com.example.temon.queuestockservice.notification.domain.dto.NotificationResponse;
import com.example.temon.queuestockservice.notification.service.NotificationService;
...
public class NotificationCtrl {
    ...
    public ResponseEntity<List<NotificationResponse>> getNotifications(
            @AuthenticationPrincipal ApiUserPrincipal userDetails) {
