...
import com.example.temon.queuestockservice.global.jwt.JwtProvider;
import com.example.temon.queuestockservice.global.jwt.WebSocketUserPrincipal;
...
public class StompHandler implements ChannelInterceptor {
    ...
    private void handleConnect(StompHeaderAccessor accessor) {
        ...
        WebSocketUserPrincipal principal =
                new WebSocketUserPrincipal(userId, role);
